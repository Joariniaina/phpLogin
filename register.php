...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $servername = "localhost"; // Remplacer par le nom d'hôte de votre base de données
        $username = "userMysql";        // Remplacer par votre nom d'utilisateur MySQL
        $password_db = "AZertyuiop123@@@!";         // Remplacer par votre mot de passe MySQL
        $dbname = "inscription"; // Remplacer par le nom de votre base de données
